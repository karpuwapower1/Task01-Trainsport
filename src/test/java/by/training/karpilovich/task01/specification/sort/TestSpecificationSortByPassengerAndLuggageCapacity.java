...
import by.training.karpilovich.task01.comparators.ComparatorByPassengerAndLuggageCapacity;
...
public class TestSpecificationSortByPassengerAndLuggageCapacity {
	...
	public void initList() throws RepositoryException {
		...
		wagons.add(new PassengerWagon(6, LuggageWagonType.BIG, PassengerWagonClass.FIRST));
	...
	public void testSpecify() {
		Specification specification = new SortSpecification(new ComparatorByPassengerAndLuggageCapacity());
		...
		expected.add(new PassengerWagon(6, LuggageWagonType.BIG, PassengerWagonClass.FIRST));
